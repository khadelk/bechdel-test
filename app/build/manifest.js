export const manifest = {
	...
	_: {
		...
		entry: {"file":"start-d6a7d488.js","js":["start-d6a7d488.js","chunks/vendor-5019805d.js"],"css":["assets/vendor-dc74a490.css"]},
		nodes: [
		...
		routes: [
			...
			},
			{
				...
				params: (m) => ({ movie: m[1]}),
				load: () => import('./server/entries/endpoints/api/movie/_movie_.json.js')
			},
			{
				type: 'page',
				key: "[id]",
