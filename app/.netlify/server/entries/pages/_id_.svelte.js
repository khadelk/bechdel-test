...
const U5Bidu5D = (0, import_index_76a30155.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"movie-info svelte-er5f3m"}" style="${"background-image: linear-gradient(#e6646580, #9198e580), url(&quot;" + (0, import_index_76a30155.e)("https://image.tmdb.org/t/p/original" + movie.backdrop_path) + "&quot;)"}"><div class="${"col-1 svelte-er5f3m"}"><img class="${"movie-poster svelte-er5f3m"}"${(0, import_index_76a30155.b)("src", "https://image.tmdb.org/t/p/w300" + movie.poster_path, 0)}${(0, import_index_76a30155.b)("alt", movie.title, 0)}></div>
    
    <div class="${"col-2 svelte-er5f3m"}"><div class="${"col-2-container svelte-er5f3m"}"><h1>${(0, import_index_76a30155.e)(movie.title)}</h1>
    <div>The Bechdel Rating for <em>${(0, import_index_76a30155.e)(movie.title)}</em> is ${(0, import_index_76a30155.e)(bechdelRating)}</div>
    ...
    <div class="${"button svelte-er5f3m"}"><a href="${"https://imdb.com/title/" + (0, import_index_76a30155.e)(movie.imdb_id)}" class="${"svelte-er5f3m"}">IMDB page
        </a></div></div></div>
